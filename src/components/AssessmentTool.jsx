...
export default function AssessmentTool() {
  ...
  return (
   <section className="py-16 px-4 bg-emerald-50 dark:bg-gray-800/50" id="assessment">
  <div className="max-w-3xl mx-auto">
    ...
    >
      <div className="inline-flex p-3 bg-emerald-100 dark:bg-emerald-900/30 rounded-full text-emerald-600 dark:text-emerald-400 mb-4">
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          ...
          <motion.a
            ...
            whileHover={{ scale: 1.03 }}
            whileTap={{ scale: 0.98 }}
            className="bg-emerald-600 hover:bg-emerald-700 dark:bg-emerald-500 dark:hover:bg-emerald-600 text-white px-6 py-3 rounded-lg flex items-center justify-center gap-2 transition"
          >
